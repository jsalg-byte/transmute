# Third-party visual asset notices

All bundled visual assets below are used in the Transmute mobile introduction.

- `assets/transmute/ouroboros.svg`: [Wikimedia Commons: Ouroboros.svg](https://commons.wikimedia.org/wiki/File:Ouroboros.svg), CC0 1.0 Universal.
- `assets/transmute/fire.svg`: [Wikimedia Commons: Alchemical fire symbol](https://commons.wikimedia.org/wiki/File:Alchemical_fire_symbol.svg), public domain.
- `assets/transmute/air.svg`: [Wikimedia Commons: Alchemical air symbol](https://commons.wikimedia.org/wiki/File:Alchemy_air_symbol.svg), public domain.
- `assets/transmute/earth.svg`: [Wikimedia Commons: Alchemical earth symbol](https://commons.wikimedia.org/wiki/File:Alchemical_earth_symbol.svg), public domain.
